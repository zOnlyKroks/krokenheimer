...
export class SpeciesImageService {
    static WIKIPEDIA_API_BASE = "https://en.wikipedia.org/w/api.php";
    static WIKIMEDIA_API_BASE = "https://commons.wikimedia.org/w/api.php";
     ...
     */
    static async getSpeciesImage(scientificName, commonName) {
     ...
     */
    static async getImageFromWikipedia(searchTerm) {
        try {
     ...
     */
    static async getImageFromWikimediaCommons(scientificName) {
        try {
     ...
     */
    static async getImageUrlFromTitle(title, isCommons = false) {
        try {
     ...
     */
    static cacheImage(cacheKey, imageUrl) {
...
//# sourceMappingURL=SpeciesImageService.js.map